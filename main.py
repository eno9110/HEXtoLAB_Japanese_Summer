...
st.title('HEXtoLAB_Japanese_Summer')
...
hex_colors = [
    ...
    "#dbc2c5", "#db8091", "#ae6b72", "#7c3138", "#a80c16",
    "#710810", "#722142", "#dee18a", "#487169", "#0b6d68",
    "#789dc9", "#6f81a9", "#153c81", "#13276b", "#596b93",
    "#47578b", "#aca9bc", "#9288bc", "#6a555d", "#2b0a1d",
    "#d5d6c8", "#9aa2b5", "#838186", "#51626a", "#1b2026",
    "#0e1331", "#8b7b62", "#3c2014"
]
...
# === CSVファイルに保存 ===
csv_filename = 'hex_to_lab_colors_Japanese_summer.csv'
df.to_csv(csv_filename, index=False)

# === CSVダウンロードボタン ===
st.write("### HEXカラーとL* a* b* 座標のCSV出力_Japanese_summer")
st.download_button(
    label="CSVをダウンロード",
...
# === Streamlitで3Dグラフ表示 ===
st.write("### L* a* b* 色空間 3D可視化_Japanese_summer")
st.plotly_chart(fig)
